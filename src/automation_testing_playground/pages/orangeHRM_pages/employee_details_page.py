...
class EmployeeDetailsPage:
    def __init__(self, page: Page):
        ...
        self.employee_id_value = "label:has-text('Employee Id') + div span"
    ...
    def wait_loaded(self):
        ...
        self.page.wait_for_selector(self.first_name_value, timeout=15000)
    ...
    def get_first_name(self) -> str:
        ...
        self.page.wait_for_selector(self.first_name_value, timeout=10000)
        first_name = self.page.locator(self.first_name_value).input_value()
    ...
    def get_middle_name(self) -> str:
        ...
        if self.page.locator(self.middle_name_value).is_visible():
            middle_name = self.page.locator(self.middle_name_value).input_value()
    ...
    def get_last_name(self) -> str:
        ...
        self.page.wait_for_selector(self.last_name_value, timeout=10000)
        last_name = self.page.locator(self.last_name_value).input_value()
    ...
    def get_employee_id(self) -> str:
        ...
        try:
            employee_id = self.page.locator(self.employee_id_value).text_content() or ""
    ...
    def click_edit(self):
        ...
        self.page.wait_for_selector(self.edit_button, timeout=10000)
    ...
    def verify_employee_details(self, expected_first_name: str, expected_last_name: str) -> bool:
